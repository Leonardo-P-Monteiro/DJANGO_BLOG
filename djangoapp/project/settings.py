...
SECRET_KEY = os.getenv('SECRET_KEY', 'WARNING: CHANGE-ME')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = bool(int(os.getenv('DEBUG', 0)))

ALLOWED_HOSTS = [
    v.strip() for v in os.getenv('ALLOWED_HOST', '').split(',') if v.strip()
]
...
AXES_COOLOFF_TIME = 0.3  # 1 inteiro é igual a 1 Hora
